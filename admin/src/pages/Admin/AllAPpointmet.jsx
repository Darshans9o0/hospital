...
const AllAPpointmet = () => {
  ...
  const {aToken , appointment  ,  getAllappointment ,  cancelAppointment} = useContext(AdminContext)
  ...
  return (
    <div className='w-full mx-w-6cl m-5'>
      <p className='mb-3 text-lg font-medium'>ALL APPOINTMENTS</p>
      <div className='bg-white border ronded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>

        <div className='hidden sm:grid  grid-cols-[0.5fr_3fr_1fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 boder-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
