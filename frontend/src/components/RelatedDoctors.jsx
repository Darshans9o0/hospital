    ...
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10' >
     ...
     <div className='w-full grid grid-cols-auto gap-4 pt-4 gap-y-6 px-3 sm:px-3'>
        {relDoc.slice(0,5).map((item , index)=> (
            <div onClick={()=>{navigate `/appointment/${item._id} ` ; scrollTo(0,0) } } className='border border-blue-200 rounded-xl overflow-hidden hover:scale-105  ease-out hover:shadow-xl transition-transform duration-300 cursor-pointer' >
